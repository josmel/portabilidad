...
class App_Controller_Action_Helper_ReceiveMessageProduccion extends Zend_Controller_Action_Helper_Abstract {
    ...
    public function __construct() {
        ...
        $this->_PASSWORD = base64_encode($this->_config['resources']['view']['passwordServer']);
    }
