...
class Zend_Soap_Wsdl
{
    ...
    public function __construct($name, $uri, $strategy = true)
    {
        ...
        $wsdl = "<?xml version='1.0' ?>
                <wsdl:definitions  targetNamespace='$uri'
                    xmlns='http://schemas.xmlsoap.org/wsdl/'
                    xmlns:tns='$uri'
                    xmlns:soap='http://schemas.xmlsoap.org/wsdl/soap/'
                    xmlns:xsd='http://www.w3.org/2001/XMLSchema'
                    xmlns:soap-enc='http://schemas.xmlsoap.org/soap/encoding/'
                    xmlns:wsdl='http://schemas.xmlsoap.org/wsdl/'></wsdl:definitions>";
    ...
    {
        $message = $this->_dom->createElement('wsdl:message');

        $message->setAttribute('name', $name);

        if (sizeof($parts) > 0) {
            foreach ($parts as $name => $type) {
                $part = $this->_dom->createElement('wsdl:part');
    ...
    {
        $portType = $this->_dom->createElement('wsdl:portType');
    ...
    {
        $binding = $this->_dom->createElement('wsdl:binding');
    ...
    public function addService($name, $port_name, $binding, $location)
    {
        ...
        $service = $this->_dom->createElement('wsdl:service');
        $service->setAttribute('name', $name);

        $port = $this->_dom->createElement('wsdl:port');
    ...
    public function addDocumentation($input_node, $documentation)
    {
        ...
        $doc = $this->_dom->createElement('wsdl:documentation');
    ...
    public function addSchemaTypeSection()
    {
        if ($this->_schema === null) {
            ...
            $types = $this->_dom->createElement('wsdl:types');
